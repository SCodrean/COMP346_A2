...
public class Client extends Thread {
    ...
    public void readTransactions() {
        ...
        String strLine;
        while (inputStream.hasNextLine() && i < maxNbTransactions) {
            try {
...
{   
    ...
    if(clientOperation.equals("receiving"))
    {
        ...
        System.out.println("\n Terminating client receving thread - Running time " + (receiveClientEndTime - receiveClientStartTime) + " milliseconds");
    }
}
}