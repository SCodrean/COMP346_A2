...
public class Network extends Thread {
    ...
    private static Semaphore sendEmptySema, receiveFullSema, emptyOutSema, fullInSema, mutexIn, mutexOut;
    ...
    Network() {
        ...
        // Semaphores
        sendEmptySema = new Semaphore(maxNbPackets);
        fullInSema = new Semaphore(0);
        mutexIn = new Semaphore(1);
        emptyOutSema = new Semaphore(maxNbPackets);
        receiveFullSema = new Semaphore(0);
